...
// TallCloudsSection renders these so they go behind the house instead of in front
export const PrizingSparkles = () => (
  <Parallax
    speed={0.2}
...
export const DesktopPrizing = () => (
  <div className="relative w-full aspect-928/609 max-xl:aspect-auto">
    {/* Content: 1200px wide, or the window's width below xl */}
    <div className="relative z-10 h-full top-0 left-0">
      <div className="mx-auto w-300 max-xl:w-full max-xl:px-6 text-white pt-50 pb-100 max-xl:pb-[26vw]">
        <h2 className="font-title text-6xl leading-none pb-10">
          {PRIZING_TITLE}
        </h2>
        <div className="w-1/2 text-[20px] flex flex-col gap-5 pb-40 max-xl:pb-0">
