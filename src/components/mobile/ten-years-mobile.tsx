...
export default function TenYearsMobile() {
  return (
    <div
      ...
      id="10-years-mobile"
    >
      <div className="relative flex flex-col px-4 pt-6 z-20">
        <Image
          ...
          <div className="flex flex-col items-center justify-center text-white">
            ...
            <div className="text-left space-y-3 px-10 text-[13px]">
              <p className="leading-relaxed">
                ...
                same year, nwPlus went on to host the largest Local Hack Day in
                North America, welcoming over 350 attendees!
              </p>
              ...
              <p className="leading-relaxed">
                Then in 2020, Local Hack Day officially transformed into what we
                now call HackCamp, a weekend-long bootcamp hackathon designed
                for beginners and tech lovers worldwide.
              </p>
            </div>
          </div>
