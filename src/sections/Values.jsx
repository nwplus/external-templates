      ...
      <Column>
        <ConfidenceContainer>
          <img
            ...
            alt="Building Confidence, Develop career-ready skills through our workshops, fight impostor syndrome, and build an invaluable support network with friends, mentors, and sponsors. You are welcome! Regardless of your background, you bring a unique and important perspective to tech."
          />
        </ConfidenceContainer>
        <PaperAndIPadContainer>
          <img
            src="/assets/Paper.svg"
            alt="Explore in a Safe Space, Discover a community of like-minded, creative, and passionate individuals. Build lasting bonds, share experiences, and create memories. We are all here unified under one cause – to strive for better representation in tech."
          />
          <IPadContainer>
            <img
              src="/assets/iPad.svg"
