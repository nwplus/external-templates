    ...
    <WorkshopsContainer id="workshops">
      <Grid>
        <Text>
          ...
          <Description>
            Not sure where to start? Don't worry, hackathons are a great place to learn new skills! Before the
            hackathon, nwHacks will host a series of workshops to help hackers gear up for the weekend. Everyone is
            invited to attend our workshops, regardless of skill level!
            <br />
            <br /> Throughout the hackathon, there will also be opportunities for hackers to attend sponsor-led
            workshops.
            <br />
            <br /> For more resources, check out our{' '}
            <a href="https://resources.nwplus.io/" target="_blank" rel="noopener noreferrer">
              self-learning wiki
            </a>
            .
          </Description>
